  ...
  return (
    <div className="home2Container">
      ...
      <main className="main">
        {/* Hero */}
        <div className="hero">
          <h1 style={{ fontSize: '32px', lineHeight: 1.2, color: '#240046', fontWeight: 700, marginBottom: '1rem' }}>
  Bem-vindo ao TN-ADM
</h1>
        ...
        <div className="features">
          <div className="feature green" onClick={() => navigate('/gestaotarefas')}>
            <i className="bi bi-check2-square"></i>
            <h3>Gestão de Tarefas</h3>
            <p>Atribua, acompanhe e conclua tarefas com facilidade.</p>
          </div>

          <div className="feature blue" onClick={() => navigate('/pagina8')}>
            <i className="bi bi-person-badge-fill"></i>
            <h3>Gestão de Usuários</h3>
            <p>Adicione, edite e monitore seus funcionários.</p>
          </div>

          <div className="feature yellow" onClick={() => navigate('/relatorios')}>
